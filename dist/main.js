...
/*!****************************!*\
  !*** ./src/event-types.js ***!
  \****************************/
/*! exports provided: PRINT_LIST, GET_ACTION, CREATE_TODO, EDIT_TODO, DELETE_TODO */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! pubsub-js */ \"./node_modules/pubsub-js/src/pubsub.js\");\n/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pubsub_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n/* harmony import */ var _todoConsole_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todoConsole.js */ \"./src/todoConsole.js\");\n/* harmony import */ var _event_types_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./event-types.js */ \"./src/event-types.js\");\n\n\n\n\n\n/* PUBSUB SYNTAX\nconst mySubscriber = (msg, data) => {\n  console.log( msg, data );\n};\nvar token = PubSub.subscribe('MY TOPIC', mySubscriber);\nPubSub.publish('MY TOPIC', 'hello world!');        */\n\n\nconst TodoController = (function() {\n  let todoList = [];\n\n  // These will need to accept an argument of the list they are editing...\n    // in which case, the DOM will need to sense which project is active\n  // OR, making this into a factory function\n    // only the \"active\" project will have subscriptions\n    // (Achieve this by removing subscriptions to CRUD topics from the inactive projects)\n    // Would these functions move to a prototype?\n\n  const createTodo = function(msg, args) { //working\n    // This happens on form completion\n    console.log(msg);\n    const newTodo = Object(_todo_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(args.title, args.description, args.dueDate, args.priority);\n    todoList.push(newTodo); // will need an edit to work with projects\n    getNextAction();\n  };\n\n  // edit\n  const editTodo = function(msg, args) {\n    // Expecting an object with:\n    // 1) an index and 2) new values for the entry\n    console.log(msg)\n    const targetIndex = args.index;\n    const newTodo = Object(_todo_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(args.title, args.description, args.dueDate,\n      args.priority);\n    todoList.splice(targetIndex, 1, newTodo)\n    getNextAction();\n  };\n\n  // delete/complete\n  const deleteTodo = function(msg, removalIndex) {\n    // Expecting \"data\" to be index to remove\n    console.log(msg);\n    todoList.splice(removalIndex, 1);\n    getNextAction();\n  };\n\n  const getNextAction = function() {\n    pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"PRINT_LIST\"], todoList);\n    // PubSub.publish(GET_ACTION); // TODO: Remove when DOM is online\n  }\n\n  let token = pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.subscribe(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_TODO\"], createTodo);\n  let token1 = pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.subscribe(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"EDIT_TODO\"], editTodo);\n  let token2 = pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.subscribe(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"DELETE_TODO\"], deleteTodo);\n\n  return\n})();\n\n\n\n// ------ Testing --------\n\nconst testTodo = Object(_todo_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Simona\\'s birthday', 'Get her a present! :)', 'January 24', 'high');\nconst testTodo1 = Object(_todo_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Socialize', 'Get in touch with friends', 'this week', 'medium');\nconst testTodo2 = Object(_todo_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Synergize', 'Network', 'ASAP', 'critical')\n\n// CREATE\npubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_TODO\"], testTodo);\npubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_TODO\"], testTodo1);\npubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_TODO\"], testTodo2);\n\n// EDIT\nconst newTestTodo = Object(_todo_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('A', 'B', 'C', 'D');\nconst editTest = Object.assign({index: 1}, newTestTodo)\nsetTimeout(() => pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"EDIT_TODO\"], editTest), 300);\n\n// DELETE\nsetTimeout(() => pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"DELETE_TODO\"], 1), 400);\n\n// GET_ACTION\nsetTimeout(() => pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish(_event_types_js__WEBPACK_IMPORTED_MODULE_3__[\"GET_ACTION\"]), 500);\n\n\n//# sourceURL=webpack:///./src/index.js?");
