...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! pubsub-js */ \"./node_modules/pubsub-js/src/pubsub.js\");\n/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pubsub_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _event_types_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./event-types.js */ \"./src/event-types.js\");\n/* harmony import */ var _project_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./project.js */ \"./src/project.js\");\n// Create, edit, and delete projects\n\n\n\n\n\nconst ProjectController = (function() {\n  // create \n  const createProject = function(msg, { projectList, title, description, participants }) {\n    // This happens on form completion\n    console.log(msg);\n    const newProject = Object(_project_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(title, description, participants);\n    projectList.push(newProject); \n    // getNextAction();\n  };\n\n  // edit\n  const editProject = function(msg, { projectList, index, title, description, participants }) {\n    console.log(msg)\n    const newProject = Object(_project_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(title, description, participants);\n    projectList.splice(index, 1, newProject)\n    // getNextAction();\n  };\n\n  // delete/complete\n  const deleteProject = function(msg, { projectList, index }) {\n    console.log(msg);\n    projectList.splice(index, 1);\n    // getNextAction();\n  };\n\n  let token0 = pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.subscribe(_event_types_js__WEBPACK_IMPORTED_MODULE_1__[\"CREATE_PROJECT\"], createProject);\n  let token1 = pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.subscribe(_event_types_js__WEBPACK_IMPORTED_MODULE_1__[\"EDIT_PROJECT\"], editProject);\n  let token2 = pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.subscribe(_event_types_js__WEBPACK_IMPORTED_MODULE_1__[\"DELETE_PROJECT\"], deleteProject);\n\n  return\n})();\n\n//# sourceURL=webpack:///./src/project-controller.js?");
